...
const TEMPLATE_PATH = `modules/${Constants.MODULE_ID}/templates/integrations/sc-more-activities/socket-recharge-effect.hbs`;

export class ScMoreActivitiesSocketRechargeActivitySheet extends dnd5e.applications.activity.ActivitySheet {
  static DEFAULT_OPTIONS = {
    classes: [
      ...
      "activity-sheet",
      "sc-sockets",
      "sc-sockets-scma-activity--recharge"
    ]
  };
